  ...
  return (
    <>
        <form onSubmit={handleFormdata}>
            ...
            <input type="text" placeholder="Enter Area..."  id="Area" name="Area" onChange={handleInput} value={student.Area} />
            <input type="text" placeholder="Enter City..."  id="city" name="city" onChange={handleInput} value={student.city} />
            <input type="number" placeholder="Enter Pincode..."  id="pincode" name="pincode" onChange={handleInput} value={student.pincode} />
